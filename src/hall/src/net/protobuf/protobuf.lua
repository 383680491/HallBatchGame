...
local function _AddPbHasMethod(message_descriptor, message_meta)
    ...
    message_meta._member.PbHas = function (self, field_name)
        ...
        if field.cpp_type == FieldDescriptor.CPPTYPE_MESSAGE then
            ...
            return true, self._fields[field]
        end
    end
end
...
local function _AddMessageMethods(message_descriptor, message_meta)
    ...
    _AddPbHasMethod(message_descriptor, message_meta)
